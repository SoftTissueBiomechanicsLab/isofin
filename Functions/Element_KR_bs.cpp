...
typedef Matrix <int, 1, Dynamic> RowVectorXi; // define row vector for integers.
 tuple<MatrixXd, MatrixXd>Element_KR_bs(MatrixXd &P, MatrixXd &Q, RowVector2d &End_pt,RowVectorXi &Ele2Cp,RowVectorXd &knotVector,int &order,RowVectorXd &weights,RowVectorXd &Mat,Matrix3d &A0,int &ngp)
{
