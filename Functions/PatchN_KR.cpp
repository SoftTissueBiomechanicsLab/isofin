...
// to be oontinued ......
tuple<SpMat_CM,MatrixXd>PatchN_KR(int &Nele,MatrixXd &P,MatrixXd &Q,MatrixXd &End_pt,MatrixXi &Ele2Cp,RowVectorXd &knotVector,int &order,RowVectorXd &weights,RowVectorXd &Mat,MatrixXi &DOF,Matrix3d &A0,int &ngp)
{ 
	...
	SpMat_CM K_patch(num_dof,num_dof); // initializing patch K(consistent tangent)(SPARSE MATRIX).
