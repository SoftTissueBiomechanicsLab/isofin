...
typedef Matrix <int, 1, Dynamic> RowVectorXi; // define row vector for integers.
 tuple<MatrixXd, MatrixXd>Element_KR(MatrixXd P, MatrixXd Q, RowVector2d End_pt,RowVectorXi Ele2Cp,RowVectorXd knotVector,int order,RowVectorXd weights,RowVectorXd Mat,Matrix3d A0,int ngp)
{
...
//                if(j1<dof-1)
//                {
//                	F_Element(r)=F_Element(r)/(Area*E);
//				}
//				else
//				{
//					F_Element(r)=F_Element(r)/(Area*E*r);
//				}
