...
tuple<MatrixXd,MatrixXd> RN_3D_BC(int &num_cpt,MatrixXd &Cpt,MatrixXd &Face_D,MatrixXd &Face_F,double u0,double disp_ratio)
{ // This function applies boundary conditions on a unit cube;
	...
	{   
		...
		// face 5 (z=1)
		if(Cpt(2,i)==1 && Cpt(1,i)!=0 && Cpt(1,i)!=1 && Cpt(0,i)!=0 && Cpt(0,i)!=1 )
		{
			Face_z1.resize(Face_z1.size()+1);Face_z1[key[4]]=i;key[4]+=1;
		}
		// face 6 (z=0)
		if(Cpt(2,i)==0 && Cpt(1,i)!=0 && Cpt(1,i)!=1 && Cpt(0,i)!=0 && Cpt(0,i)!=1 )
		{
