function [ K_patch,R_patch ] = PatchN_KR(Nele,P,Qf,End_pt,Ele2Cp,knotVector,order,weights,Mat,DOF,A0,ngp)
...
for i=1:Nele %% MAKE PARALLEL HERE
    ...
    [ K_ele,R_ele ]=Element_KR(P,Qf,End_pt(i,:),Ele2Cp(i,:),knotVector,order,weights,Mat,A0,ngp);
