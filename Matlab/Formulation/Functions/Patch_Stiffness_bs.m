function [ K_Patch ] = Patch_Stiffness_bs(K_Patch,Nele,P,Q,End_pt,Ele2Cp,knotVector,order,weights,Mat,DOF,NC,A0,ngp)
...
for i=1:Nele 
      K_ele=Element_Stiffness_bs(P,Q,End_pt(i,:),Ele2Cp(i,:),knotVector,order,weights,Mat(i,:),A0,ngp);
