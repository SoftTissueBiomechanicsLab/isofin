function [ R_patch ] = PatchN_R_New(Nele,P,Qf,End_pt,Ele2Cp,knotVector,order,weights,Mat,DOF,A0,ngp)
...
for i=1:Nele %% MAKE PARALLEL HERE
    ...
    [ R_ele ]=Element_R_New(P,Qf,End_pt(i,:),Ele2Cp(i,:),knotVector,order,weights,Mat,A0,ngp);
