function [ F_Element ] = Element_R_bs(P,Q,End_pt,Ele2Cp,knotVector,order,weights,Mat,A0,ngp)
...
% %                         as(k1,1)=N(1,k);a1s(k1,1)=dN1(i,k);a11s(k1,1)=dN2(i,k);
