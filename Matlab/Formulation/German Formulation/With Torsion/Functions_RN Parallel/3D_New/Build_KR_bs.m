function [ K,R,Q,Reaction ] = Build_KR_bs(Nele,NOS_Total,P,Q,End_pt,Ele2Cp,knotVector,order,weights,Mat,DOF,A0,ngp,D_DOF,F_DOF)
...
parfor i=1:Nele % Parallel for loop here.
  ...
  [ K_ele,R_ele ]=Element_KR_bs(P,Q,End_pt(i,:),Ele2Cp(i,:),knotVector,order,weights,Mat(i,:),A0,ngp);
