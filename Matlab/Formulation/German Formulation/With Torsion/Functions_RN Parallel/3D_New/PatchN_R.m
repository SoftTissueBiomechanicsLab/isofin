function [ R ] = PatchN_R(Nele,P,Qf,End_pt,Ele2Cp,knotVector,order,weights,Mat,DOF,A0,ngp)
...
parfor i=1:Nele 
  [ R_ele ]=Element_R(P,Qf,End_pt(i,:),Ele2Cp(i,:),knotVector,order,weights,Mat,A0,ngp);
  R_temp=zeros(nos*4,1);
