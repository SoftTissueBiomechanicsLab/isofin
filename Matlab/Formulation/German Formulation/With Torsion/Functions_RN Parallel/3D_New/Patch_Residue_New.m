function [ F_Patch ] = Patch_Residue_New(Nele,P,Q,End_pt,Ele2Cp,knotVector,order,weights,Mat,DOF,A0,ngp)
...
nos=size(P,2);
F_Patch=zeros(nos*4,1);
for i=1:Nele
      F_ele=Element_Residue(P,Q,End_pt(i,:),Ele2Cp(i,:),knotVector,order,weights,Mat(i,:),A0,ngp);
