...
filepath = ['../../Results/Paraview/3D/',num2str(fiber_num),'_',num2str(Case),'_',num2str(New_Case),'/',deformation_type];
...
% Group each increment into an individual cell for use in parfor loop below
