...
{    
	...
	ResultFileDir="..//Results//Outputs//"; // directory where result data and input file is stored.
	// Scalars
	double Max_Disp;
	...
	// Mat, Mat_Bs, Mat_Arcs,Max_Disp,u0,Face_D,Face_F,Vec1,Vec2 are OUT Variables
  ...
  //// Dof's for fibers and arcs and bending strips ////
	MatrixXi DOF,DOF_Bs;
	DOF.resize(num_cpt,4);
	DOF_Bs.resize(num_cpt,4);
	DOF_Bs=MatrixXi::Zero(num_cpt,4);
